...
public class CharacterInputAppState extends AbstractAppState implements AnalogListener, ActionListener {
  ...
  */
 protected GameCharacterControl character;
 /**
  * Camera sensitivity.
  */
 protected float sensitivity = 80;
 ...
 /**
  * Called on input from an analog device (such as mouse movement or individual
  * joysticks).
  *
